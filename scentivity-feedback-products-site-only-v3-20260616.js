/* Scentivity feedback product selector V3
   Product-name-only dropdown: shows and submits only the product name.
   Uses data/products.json when available and falls back to products already rendered on the page.
*/
(() => {
  'use strict';

  const SCRIPT_ID = 'scentivity-feedback-products-site-only-v3';
  if (window.__scentivityFeedbackProductsV3Installed) return;
  window.__scentivityFeedbackProductsV3Installed = true;
