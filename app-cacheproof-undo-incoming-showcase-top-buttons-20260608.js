// SCENTIVITY_UNDO_INCOMING_SHOWCASE_TOP_BUTTONS_20260608
...
// Opens cart/catalogue when returning from product page buttons
(function scentivityHomepageLandingFromProductPage() {
  function openRequestedPanel() {
    const params = new URLSearchParams(window.location.search);
    if (params.get('openCart') === 'true' || window.location.hash === '#cart') {
      window.setTimeout(() => {
