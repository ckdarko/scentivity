// SCENTIVITY_PRODUCT_PAGE_PRODUCTS_SHOP_FEEDBACK_FIX_20260608
...
async function initProductPage() {
  ...
  try {
    ...
    let reviews = Array.isArray(data.customerReviews) ? data.customerReviews : [];
    try {
    ...
    if (!product || !isProductPublished(product)) {
      productPageContent.innerHTML = `
        <div class="empty-state">
          ...
          <p>This product is currently hidden from the website.</p>
