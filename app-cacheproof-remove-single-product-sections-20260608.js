...
function renderHomepageShowcase() {
  // Removed by request: do not show single-product slideshow cards on the homepage.
  const singleProductSection = document.querySelector('#featured-products, .homepage-showcase');
  if (singleProductSection) {
    singleProductSection.remove();
  }
}
